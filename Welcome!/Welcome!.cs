...
if you have it in your database. It should default to English if the language is not in the database, or in the event of 
an invalid input.
...
public static class Kata
{
    public static string Greet(string language)
    {
      Dictionary<string, string> translate = new Dictionary<string, string>()
        ...
        return translate.ContainsKey(language) ? translate[language] : "Welcome";
    }
}